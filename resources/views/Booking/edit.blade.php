...
<div class="container mx-auto mt-8">
    <div class="bg-white p-4 rounded-lg shadow-lg">
        ...
        <table class="table-auto  w-3/5 mx-auto">
            <tbody>
                <tr>
                ...
                <tr>
                    <td class="text-gray-800">{{ $booking->room->name }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="w-1/4 p-2 rounded-lg mt-2 border border-gray-300 focus:outline-none focus:border-blue-500" id="extra_service_charge" name="extra_service_charge" value="{{ $booking->extra_service_charge }}" oninput="updateTotalAmount()">
                    </td>
                </tr>
                <tr>
        ...
        <form action="{{ route('booking.update', $booking->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <select class="w-1/4 p-2 rounded-lg mt-2 border border-gray-300 focus:outline-none focus:border-blue-500" id="payment_status" name="payment_status">
